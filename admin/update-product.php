         ...
         <tr>
            ...
            <tr>
             ...
             <td>
                <?php
                    if($current_image != ""){
                        ?>
                        <img src="<?= BASE_URL ?>images/Product/<?php echo $current_image; ?>" width="120px">
                   <?php
                }
                    else{
            ...
            <tr>
                <td>
                    ...
                    <input type="submit" name="submit" class="btn-secondary" value="Update Product">
                </td>
            </tr>
         </table>
...
if(isset($_POST['submit'])){
    ...
    if($res3==TRUE)
    {
        $_SESSION['update']="<div class='success'>Product is updated successfully!</div>";
        header('location:'.SITEURL.'admin/manage-product.php');
    }
    else{
        $_SESSION['update']="<div class='error'>Failed to update Product. Try again later!</div>";
        header('location:'.SITEURL.'admin/manage-product.php');
    }
}
